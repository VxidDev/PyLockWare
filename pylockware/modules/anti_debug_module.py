...
class AntiDebugModule(ModuleBase):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        self.mode = self.config.get('mode', 'strict')  # Can be 'normal' or 'strict'
    ...
    def process(self, project_path: Path, output_path: Path) -> bool:
        ...
        try:
            ...
            # Copy the appropriate protection module to the output directory
            if self.mode == 'normal':
    ...
    def validate_config(self) -> bool:
        ...
        if self.mode not in ['normal', 'strict']:
            print(f"Invalid anti-debug mode: {self.mode}. Valid options are 'normal' or 'strict'.")
            return False
        return True
